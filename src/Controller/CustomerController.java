	...
	public void customer() throws Exception {
		...
		do {
			...
			case 2:
				...
				order.setPname(prod_name);
				order.setAdress(adress);
				order.setPrice(prod_price);
			...
			case 3:
				...
				if(list1!=null)
				{
					System.out.println("OrderID         Name           Product Name        Adress       Price          Quantity ");
			
					for(Order o: list1) {
						
						System.out.println("=============================================================================================================");
						System.out.println(o.getId()+"             "+o.getCustname()+"               "+o.getPname()+"             "+o.getAdress()+"         "+o.getPrice()+"             "+o.getQuantity());
					}
					System.out.println(">>=========================================================================================================<<");	
				}
