...
public class Bill {
	...
	public void generateBill(String name) throws Exception
	{
		...
		PdfWriter.getInstance(my_bill, new FileOutputStream("C:\\Users\\dell\\Desktop\\Bill.pdf"));
		my_bill.open();
		...
		do{
			...
			Paragraph p3 = new Paragraph( "Product Name      :          "+pName+"\n");
			my_bill.add(p3);
			String padress = rs.getString(4);
			Paragraph p4 = new Paragraph( "Address      :          "+padress+"\n");
			my_bill.add(p4);
			String pPrice = rs.getString(5);
			Paragraph p5 = new Paragraph( "Product Price in Rs       :    Rs      "+pPrice+"\n");
			my_bill.add(p5);
